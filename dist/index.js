...
const Y = ["href"], Z = /* @__PURE__ */ E({
  ...
  setup(e) {
    const d = e, x = q(() => d.annotation ? d.annotation.split("	")[0] : ""), t = q(() => d.annotation ? d.annotation.split("	")[2] : ""), o = q(() => d.annotation ? d.annotation.split("	")[1] : "");
  ...
  setup(e) {
    const d = e, x = q(() => d.annotation ? d.annotation.split("$$$$")[0] : ""), t = q(() => {
      let o = `${x.value}`, $ = d.annotation ? d.annotation.split("$$$$")[1].split(/\r?\n/).filter((n) => n) : [], T = [];
      return $.forEach((n) => {
...
}), oe = `.o_term[data-v-922a42fb]{background-color:#cdcdcd;border-radius:4px;padding:1px 3px}
`, j = (e, d) => {
  const x = e.__vccOpts || e;
  for (const [t, o] of d)
    x[t] = o;
  return x;
}, ae = /* @__PURE__ */ j(te, [["styles", [oe]], ["__scopeId", "data-v-922a42fb"]]), ne = { class: "auto-search-wrapper" }, le = { key: 0 }, re = ["onInput", "placeholder"], ie = { key: 1 }, se = {
  key: 2,
  class: "auto-results-wrapper auto-is-active"
}, ue = {
  tabindex: "0",
  role: "listbox"
}, de = ["onClick"], ce = ["innerHTML"], pe = ["innerHTML"], fe = {
  key: 3,
  type: "button",
  ...
  setup(e, { emit: d }) {
    ...
    const f = q(() => a.value ? x.format && x.format == "json" ? a.value : a.value ? a.value.label + "	" + a.value.ontology_prefix + "	" + a.value.iri + "	" + a.value.type : "" : null), u = (v) => {
      a.value = v, t.value = v.label, d("change", f.value), o.value = [];
    };
...
`, he = /* @__PURE__ */ j(ve, [["styles", [ge]], ["__scopeId", "data-v-d4fc57ea"]]), xe = (e) => (Q("data-v-72d4acfd"), e = e(), X(), e), me = ["id"], ye = {
  key: 0,
...
$$$$
` + v.map(
        (c) => c.ontology.type[0] + "	" + c.ontology.ontology_prefix + " " + c.context.start + " " + c.context.end + "	" + c.ontology.label + "	" + c.ontology.iri
      ).join(`
`) : null;
    });
    J(() => {
    ...
    function O(s) {
      T.value = s.target.innerText, d("change", y.value);
    }
    function z(s) {
      let c = {
        ontology: {},
      ...
      if (!$)
        ...
        c = { ontology: s, context: _ };
      }
      v.push(c), u.value = [], a.value = "", d("change", y.value);
    }
    function I(s) {
      if (a.value = "", window.getSelection) {
        var c = window.getSelection();
        a.value = c?.toString(), a.value && a.value != "" ? (u.value = [], D(c), A(s)) : (n.value = { x: -1e3, y: 0, start: -1, end: -1 }, u.value = []);
      }
    }
    function D(s, c = !0) {
      if (!s?.rangeCount)
    ...
    async function A(s) {
      if (a.value === "")
        return u.value = [], [];
      let c = a.value.indexOf(":"), _ = "", S = null;
      c < 0 ? (_ = x.ontologies, S = a.value) : (S = a.value.split(":")[1], _ = a.value.split(":")[0]);
...
`, ze = /* @__PURE__ */ j(Ie, [["styles", [Oe]], ["__scopeId", "data-v-72d4acfd"]]), Ee = { key: 0 }, Le = ["onKeyup", "onChange"], Ae = { key: 1 }, Re = { key: 2 }, je = { key: 3 }, De = /* @__PURE__ */ E({
...
}), Ve = `.o_annotate_textarea[data-v-030af0eb]{min-height:100px;width:100%;border:1px solid #d7d7d7;box-shadow:none;box-sizing:border-box;padding:12px 10px;resize:none}#mainInput[data-v-030af0eb]{background:transparent;color:#000;opacity:100}#autocomplete[data-v-030af0eb]{position:absolute;box-sizing:border-box;cursor:text;pointer-events:none;color:#000;opacity:.6;background:transparent}
`, He = /* @__PURE__ */ j(De, [["styles", [Ve]], ["__scopeId", "data-v-030af0eb"]]), Ue = L(Z), Be = L(ae), Ne = L(he), Ke = L(ze), We = L(He);
if (typeof window < "u") {
